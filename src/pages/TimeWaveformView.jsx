    ...
    const fetchVelocitySeries = useCallback(async (payload, meta = {}) => {
        ...
        try {
            ...
            setVelocityMeta({
                ...
                measurementId: meta.measurementId ?? payload.id ?? responseBody?.id,
                timestamp:
    ...
    useEffect(() => {
        const initData = async () => {
            ...
            try {
                ...
                // Force domain to time for this view
                const domain = "time";
                const timestamp =
    ...
    return (
        <section className="dashboard-card">
            <div className="dashboard-card__header">
                <div>
                    <p className="dashboard-card__eyebrow">Time Waveform</p>
                    <h2>Velocity Time Waveform</h2>
                </div>
                {formattedTimestamp && (
...
export default TimeWaveformView;
